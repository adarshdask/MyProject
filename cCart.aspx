...
<table width="100%"><tr><td>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
        ConnectionString="<%$ ConnectionStrings:shopingConnectionString1 %>" 
         SelectCommand="SELECT Mob,Email FROM [UDetail] WHERE ([UserId] = @uName)">
        <SelectParameters>
            <asp:Parameter Name="Mob" Type="String" />
            <asp:Parameter Name="Email" Type="String" />
        </SelectParameters>
        <SelectParameters>
            <asp:CookieParameter CookieName="Email" Name="Email" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <td> 
     <div id="mob">mobile no        :<asp:TextBox ID="TextBox3" runat="server" 
            BorderColor="#CC3300" Enabled="True" 
        Font-Bold="True" ForeColor="Red"></asp:TextBox></div><br/><br/>
     <div id="email">email      :<asp:TextBox ID="TextBox4" runat="server" 
            BorderColor="#CC3300" Enabled="True" 
        Font-Bold="True" ForeColor="Red"></asp:TextBox></div> <br/>
     <div id="cost">Total Cost   :<asp:TextBox ID="TextBox2" runat="server" 
            BorderColor="#CC3300" Enabled="False" 
        Font-Bold="True" ForeColor="Red"></asp:TextBox></div>
