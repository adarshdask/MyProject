...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="800px" cellpadding="3" ForeColor="#4A3C8C" style="height: 451px; margin-bottom: 118px" >
    <tr>
        <td>
            First Name
        </td>
    ...
    <tr>
        <td class="auto-style1">
            Ration Card No.</td>
        <td class="auto-style1">
            <asp:TextBox ID="TextBox8" runat="server" BorderColor="#CC3300" Enabled="False" Height="22px" style="margin-right: 3px" Width="189px" ForeColor="Red"></asp:TextBox>
        </td>
    </tr>
</table>
