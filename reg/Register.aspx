...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="800px" cellpadding="3" ForeColor="#4A3C8C" class="auto-style2" >
    <tr>
    ...
    <tr>
        <td bgcolor="White" class="auto-style3">
            ...
            <td bgcolor="White"><asp:TextBox ID="TextBox3" runat="server" Height="22px" Width="189px" 
                         ></asp:TextBox> 
        ...
        <td bgcolor="White">
            <asp:TextBox ID="TextBox8" runat="server" Width="189px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                ForeColor="#FF3300" ControlToValidate="TextBox8" Display="Dynamic" ErrorMessage="you should enter this field"></asp:RequiredFieldValidator>
        </td>
    </tr>
</table>

    <asp:ImageButton ID="ImageButton1" runat="server" 
        ImageUrl="~/img/str/buttons/submit_blue.png" onclick="ImageButton1_Click" Height="22px" Width="92px" />
<br /><br />
